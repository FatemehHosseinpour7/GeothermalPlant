...
from lib.settings import NAME, WELL_TEMPAROSSA, WELL_VILLAFORTUNA1, WELL_TRECATE4, WELL_GELA, WELL_CASTEGGIO
...
for x in range (len(portata_step)):
    ...
    twat_out = twat_lateral_depth_evaluation(Tr, twat_down, L, portata, cpw, t[0], rtube)
    twat_up = twat_Uup_evaluation(zz, twat_out, t[0], rwell, vel, dhydr, portata, cpw, tground1, twat_value, resconv, resgrout)
