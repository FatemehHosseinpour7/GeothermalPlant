...
SENSIBILITY = {
    # CPROCK
    'CPROCK_START': 1050, #j/kg/k
    'CPROCK_STEP': 0, #j/kg/k
    ...
    # RHOROCK
    'RHOROCK_START': 2500, #kg/m^3
    'RHOROCK_STEP': 0, #kg/m^3
    'RHOROCK_STOP': 2500, #kg/m^3
    #'RHO_CPROCK': 820, #j/kg/k
    #'RHO_CONDROCK': 2.5, #W/m/K
        #ALPHA SENSIBILITY TRECATE4
    'A_CPROCK_START': 650, #j/kg/k
    'A_CPROCK_STOP': 1050, #j/kg/k
    'A_CONDROCK_START': 1.5, #j/kg/k
    'A_CONDROCK_STOP': 3.5, #j/kg/k
    'A_RHOROCK_START': 1000, #j/kg/k
    'A_RHOROCK_STOP': 2500, #j/kg/k
    'VALUE_STEP': 10
    }
